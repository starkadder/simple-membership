...
class SwpmShortcodesHandler {
    ...
    public function __construct() {
        ...
        add_shortcode('swpm_login_link', array(&$this, 'swpm_show_login_link_sc'));
    }
    ...
    public function swpm_show_login_link_sc($args) {
      ...
      if ($auth->is_logged_in()) {
	//User is logged in
	return  '<a href="'.$logout_url.'">'.SwpmUtils::_('Logout').'</a>';
      } else {
	//User not logged in.
	return '<a href="'.$login_page_url.'">'.SwpmUtils::_('Login').'</a>';
      }
