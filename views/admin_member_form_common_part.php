...
<tr>
    <th scope="row"><label for="instrument"><?php echo SwpmUtils::_('Instrument') ?></label></th>
    <td><input name="instrument" type="text" id="instrument" class="regular-text" value="<?php echo esc_attr($instrument); ?>" /></td>
</tr>      
<tr>
