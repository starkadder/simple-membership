...
<div class="swpm-edit-profile-form">
    <form id="swpm-editprofile-form" name="swpm-editprofile-form" method="post" action="" class="swpm-validate-form">
        ...
        <table>
            ...
            <tr class="swpm-profile-instrument-row">
                <td><label for="instrument"><?php echo SwpmUtils::_('Instrument'); ?></label></td>
                <td><select id="instrument" name="instrument"><?php echo SwpmMiscUtils::get_instruments_dropdown($instrument) ?></select></td>
            </tr>            
<!-- Dont show membership level
